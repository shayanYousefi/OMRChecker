...
class QueueConsumer(object):
    ...
    def __init__(self, amqp_url, s3_client):
        ...
        """
        self.EXCHANGE = os.getenv("RABBIT_EXCHANGE", "3A")
        self.QUEUE = os.getenv("RABBIT_AZMOONS_QUEUE")
        self.ROUTING_KEY = os.getenv("RABBIT_AZMOONS_ROUTING_KEY")
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(
            queue=queue_name, callback=cb, durable=True, arguments={"x-consumer-timeout": 86400000})
...
class ReconnectingQueueConsumer(object):
    ...
    QueueConsumer indicates that a reconnect is necessary.
